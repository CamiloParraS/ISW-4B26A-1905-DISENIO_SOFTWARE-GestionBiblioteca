...
public class LibroServiceImpl implements LibroService {
    ...
    public List<LibroResponse> listarLibros() {
        ...
        return libroRepository.findAll().stream().map(this::mapToResponse)
    ...
    private LibroResponse mapToResponse(Libro libro) {
        return new LibroResponse(libro.getId(), libro.getIsbn(), libro.getTitulo(),
                libro.getAutor(), libro.getAnioPublicacion(), libro.getCategoria());
    }
}
